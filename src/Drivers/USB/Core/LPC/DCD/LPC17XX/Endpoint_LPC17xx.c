...
void DMANewTransferRequestISR(void)
{
	uint32_t PhyEP;
...
// {
// 	uint32_t PhyEP;
// 	uint32_t SysErrIntSt = LPC_USB->SysErrIntSt;
// 	for (PhyEP = 2; PhyEP < USED_PHYSICAL_ENDPOINTS; PhyEP++)              /* Check All Endpoints */
// 	{
...
// 		}
// 	}
// 	LPC_USB->SysErrIntClr = SysErrIntSt;
// }
...
void DcdIrqHandler (uint8_t DeviceID)
{
	...
	DevIntSt = LPC_USB->DevIntSt & LPC_USB->DevIntEn;                      /* Device Interrupt Status */
	...
	/* DMA mode */
	DMAIntSt = LPC_USB->DMAIntSt & LPC_USB->DMAIntEn;
